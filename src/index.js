...
function init(){
	...
	//create light
		...
		//envirement
		const ambientLight = new AmbientLight(new Color('#fff'), 0.1);
	...
	const groundMaterial = new MeshBasicMaterial( {color: '#1D261D', side: DoubleSide} );
	...
	//create objects
		...
		const buildingMaterial = new MeshLambertMaterial({color:'#333333', side: DoubleSide});
		...
		//lamp-post
			...
			const baseLampPostMaterial = new MeshBasicMaterial( {color: '#505050', side: DoubleSide} ); luminaire
			...
			const baseTrunkPostMaterial = new MeshBasicMaterial( {color: '#505050'} );
			...
			luminaire = new Mesh( topBasePostGeometry, luminairePostMaterial );
				...
				luminairePostMaterial.position = luminaire.position;
			...
			const topBasePostSphereMaterial = new MeshBasicMaterial( {color: '#505050', side: DoubleSide} );
			...
			const lampPostMaterial = new MeshBasicMaterial( {color: '#A59A3D', side: DoubleSide} );
			...
			//light for lamp
			const pointLight = new PointLight( 0xA59A3D, 3, 20, -10 );
			...
			const torusMaterial = new MeshBasicMaterial( { color: 0x505050 } );
			...
			const torusLampConnectionMaterial = new MeshBasicMaterial( { color: 0x505050 } );
